...
type MsgBuyName struct {
	...
	Md5     []string `protobuf:"bytes,3,rep,name=md5,proto3" json:"md5,omitempty"`
}
...
func (m *MsgBuyName) GetIndex() uint64 {
	if m != nil {
		return m.Index
	}
	return 0
...
func (m *MsgBuyName) GetMd5() []string {
	if m != nil {
		return m.Md5
	}
	return nil
...
var fileDescriptor_df4dec9b515ec245 = []byte{
	...
	0x2b, 0xf9, 0x71, 0x71, 0xf9, 0x16, 0xa7, 0x3b, 0x95, 0x56, 0xfa, 0x25, 0xe6, 0xa6, 0x0a, 0x49,
	0x70, 0xb1, 0x27, 0x17, 0xa5, 0x26, 0x96, 0xe4, 0x17, 0x49, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06,
	0xc1, 0xb8, 0x42, 0x22, 0x5c, 0xac, 0x99, 0x79, 0x29, 0xa9, 0x15, 0x12, 0x4c, 0x0a, 0x8c, 0x1a,
	0x2c, 0x41, 0x10, 0x8e, 0x90, 0x00, 0x17, 0x73, 0x6e, 0x8a, 0xa9, 0x04, 0xb3, 0x02, 0xb3, 0x06,
	0x67, 0x10, 0x88, 0xa9, 0x24, 0xc2, 0x25, 0x84, 0x30, 0x2f, 0x28, 0xb5, 0xb8, 0x20, 0x3f, 0xaf,
	0x38, 0xd5, 0xa8, 0x8c, 0x8b, 0xd9, 0xb7, 0x38, 0x5d, 0x28, 0x9f, 0x8b, 0x1d, 0x66, 0x93, 0xae,
	0x1e, 0x41, 0xb7, 0xe9, 0x21, 0x0c, 0x92, 0x32, 0x25, 0x49, 0x39, 0xcc, 0x5e, 0x27, 0xbf, 0x13,
	...
	0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0x87, 0x1b, 0xad, 0x8f, 0x1c, 0x8a, 0x15, 0x28, 0xbc, 0x92, 0xca,
	0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0xb8, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xb9, 0xd9,
	0xf0, 0x5c, 0x6f, 0x01, 0x00, 0x00,
}
...
func (m *MsgBuyName) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Md5) > 0 {
		for iNdEx := len(m.Md5) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Md5[iNdEx])
			copy(dAtA[i:], m.Md5[iNdEx])
			i = encodeVarintTx(dAtA, i, uint64(len(m.Md5[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *MsgBuyName) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Md5 = append(m.Md5, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
